...
content += '<thead><tr><th style="width: 1%">ID</th><th>Tên sản phẩm</th><th>Loại sản phẩm</th><th>Giá khởi điểm</th><th>Hình ảnh</th><th>Người đăng</th><th>Trạng thái</th><th>Thao tác</th></tr></thead>';
content += '<tbody>';
...
for (var i=0; i<products.length; i++)
{
    ...
    if (products[i].status=="Đang đấu giá")
 		content += '<td><button type="button" class="btn btn-success btn-xs">'
 	else content += '<td><button type="button" class="btn btn-default btn-xs">';
 	content += products[i].status + "</td>";
